<%-- 
    Document   : datos_usuarioU
    Created on : 29/11/2018, 10:23:06 PM
    Author     : win 10
--%>
   ...
   <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <ul class="nav navbar-nav navbar-right">
		  ...
		  <li><a href="http://localhost:8090/WebIndividual/CatalogoU.jsp"><i class="fas fa-book" aria-hidden="true"></i></a></li>
...
<table> 
	...
	<A HREF = "http://localhost/9no/P%20individual/MUserU.php?Usuario=<?php echo $User?>&Contra=<?php echo $Pass?>"
